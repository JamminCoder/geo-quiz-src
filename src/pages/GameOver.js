...
export default function GameOver({ game, continentName }) {
    return(
        <>
            ...
            <Link onClick={ GameManager.newGame } to={`/quiz/${ continentName }`} className='btn bg-purple-600 text-white font-medium mb-8'>Take Quiz for { createProperName(continentName) }</Link>
